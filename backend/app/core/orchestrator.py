...
class MasterOrchestrator:
    ...
    async def create_simulation(
        self, world_config: Dict[str, Any], character_configs: List[Dict[str, Any]]
    ) -> str:
        """创建新的模拟"""
    ...
    async def start_simulation(self, simulation_id: str):
        ...
        await self.state_store.update_simulation(
            simulation_id, {"status": SimulationStatus.RUNNING.value}
        )
    ...
    async def pause_simulation(self, simulation_id: str):
        ...
        await self.state_store.update_simulation(
            simulation_id, {"status": SimulationStatus.PAUSED.value}
        )
    ...
    async def stop_simulation(self, simulation_id: str):
        ...
        await self.state_store.update_simulation(
            simulation_id, {"status": SimulationStatus.STOPPED.value}
        )
    ...
    async def complete_simulation(self, simulation_id: str):
        ...
        await self.state_store.update_simulation(
            simulation_id, {"status": SimulationStatus.COMPLETED.value}
        )
